# Pre-Refactor Changelog Notes

This file preserves the older changelog notes that referred to the repository's
pre-refactor `V1.6` and solver-first transition period.
...
- docs(task_A): align Task A live docs and task-side Arm-2 output contracts to the Block 0 / Block 1 / Block 2 proposal framing
