"""Internal `3C-1` subbag-consistency-ablation row builder."""
...
BLOCK3_SUBEXPERIMENT_ID = Block3SubexperimentId.CONSISTENCY_ABLATION.value
...
def build_3c1_rows(
    *,
    ...
    """Build raw and review rows for `3C-1` subbag consistency ablation."""
    ...
    return build_core_ablation_rows(
        ...
        ablation_method_name="consistency_ablation",
        ablation_mode="consistency",
        runtime=runtime,
    )


__all__ = ["BLOCK3_SUBEXPERIMENT_ID", "build_3c1_rows"]
