...
surface. Neither layer consumes prepare, descriptive-atlas, old suitability,
or passed-bundle artifacts, and neither emits biological interpretation or
downstream execution decisions. See
