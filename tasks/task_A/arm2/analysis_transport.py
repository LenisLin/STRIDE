...
def build_global_transport_summary(pair_level_transport: pd.DataFrame) -> pd.DataFrame:
    ...
    output_columns = [
        ...
        "tc_im_valid_continuity_pair_count",
        "tc_pt_valid_continuity_pair_count",
        "tc_im_median_bounded_residual_abs",
        "tc_pt_median_bounded_residual_abs",
        "patient_median_tc_pt_minus_tc_im_bounded_residual_abs",
        "tc_im_median_continuity_backbone_fraction",
        "tc_pt_median_continuity_backbone_fraction",
        "patient_median_tc_pt_minus_tc_im_continuity_backbone_fraction",
        "tc_im_median_bounded_residual_fraction",
        "tc_pt_median_bounded_residual_fraction",
        "patient_median_tc_pt_minus_tc_im_bounded_residual_fraction",
        "tc_im_median_open_relation_match_score",
        "tc_pt_median_open_relation_match_score",
        "patient_median_tc_pt_minus_tc_im_open_relation_match_score",
        "tc_im_median_source_depletion_prone_abs",
        "tc_pt_median_source_depletion_prone_abs",
        "patient_median_tc_pt_minus_tc_im_source_depletion_prone_abs",
        "tc_im_median_target_emergence_prone_abs",
        "tc_pt_median_target_emergence_prone_abs",
        "patient_median_tc_pt_minus_tc_im_target_emergence_prone_abs",
        "tc_im_median_continuity_backbone_abs",
        "tc_pt_median_continuity_backbone_abs",
        "patient_median_tc_pt_minus_tc_im_continuity_backbone_abs",
        "tc_im_median_closed_comparator_match_score",
        "tc_pt_median_closed_comparator_match_score",
        "patient_median_tc_pt_minus_tc_im_closed_comparator_match_score",
        "tc_im_median_forced_closure_excess",
        "tc_pt_median_forced_closure_excess",
        "patient_median_tc_pt_minus_tc_im_forced_closure_excess",
    ]
    ...
    patient_family_summary = (
        ...
        .agg(
            ...
            valid_continuity_pair_count=("uot_status", lambda s: int(pd.Series(s).astype(str).eq("ok").sum())),
            median_bounded_residual_abs=("U_abs", "median"),
            median_continuity_backbone_fraction=("transport_fraction", "median"),
            median_bounded_residual_fraction=("unmatched_fraction", "median"),
            median_open_relation_match_score=("M", "median"),
            median_source_depletion_prone_abs=("D_pos", "median"),
            median_target_emergence_prone_abs=("B_pos", "median"),
            median_continuity_backbone_abs=("T_abs", "median"),
            median_closed_comparator_match_score=("M_balanced", "median"),
            median_forced_closure_excess=("balanced_minus_uot", "median"),
        )
        .reset_index()
    )
    wide = _pivot_confirmatory_family_values(
        ...
        value_columns=[
            "ordered_pair_count",
            "valid_continuity_pair_count",
            "median_bounded_residual_abs",
            "median_continuity_backbone_fraction",
            "median_bounded_residual_fraction",
            "median_open_relation_match_score",
            "median_source_depletion_prone_abs",
            "median_target_emergence_prone_abs",
            "median_continuity_backbone_abs",
            "median_closed_comparator_match_score",
            "median_forced_closure_excess",
        ],
    )
    for metric in (
        "bounded_residual_abs",
        "continuity_backbone_fraction",
        "bounded_residual_fraction",
        "open_relation_match_score",
        "source_depletion_prone_abs",
        "target_emergence_prone_abs",
        "continuity_backbone_abs",
        "closed_comparator_match_score",
        "forced_closure_excess",
    ):
